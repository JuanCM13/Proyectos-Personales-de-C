...
int ll_sort2(LinkedList* this , LinkedList* this2 , int (*pFunc)(void* ,void*), int (*pFunc2)(void* ,void*) )
{
	int returnAux = -1;
	int i;
	int j;
	...
	if(this != NULL && this2 != NULL && pFunc != NULL && pFunc2 != NULL)
	{
		largo = ll_len(this);
		largo2 = ll_len(this2);
		...
		for(i=0 ; i<largo-1 ; i++)
		{
			...
			for(j=i+1 ; j<largo ; j++)
			{
				...
				resultado = pFunc(auxUnoPelement , auxDosPelement);
				if(resultado > 0)
				{
					auxSwap = auxUnoPelement;
					ll_set(this , i , auxDosPelement);
				...
				else
				{
					if(resultado == 0)
					{
						for(a=0 ; a<largo2-1 ; a++)
						{
							for(b=a+1 ; b<largo2 ; b++)
							{
								printf("Estoy entrando\n");
								auxUnoPelement = ll_get(this2 , a);
								auxDosPelement = ll_get(this2 , b);

								if(pFunc2(auxUnoPelement , auxDosPelement) > 0)
								{
									printf("Estoy entrando2\n");
									auxSwap = auxUnoPelement;
									ll_set(this , i , auxDosPelement);
									ll_set(this , j , auxSwap);
								}

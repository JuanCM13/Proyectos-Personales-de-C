...
/** \brief Recorre una linkedList y la devuelve con o sin modificaciones dadas por la funcion (fn) pasada por parametro, se recorre la lista y se le pasa
 * 	a esa funcion el elemento de cada nodo de la linkedList
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return el puntero a LinkedList* recibido (modificado o no)
 */

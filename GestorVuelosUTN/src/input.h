...
/**
 * @brief Valida si una cadena de caracteres es de tipo fecha (contiene 11 caracteres y tiene que contener barras)
 * @param cadena: Cadena de caracteres a verificar
 * @param rango: Largo de la cadena a verificar
 * @return Retorna -1 si hubo algun error con los NULL , -2 si encuentra caracter no perteneciente a un entero, 0 si la cadena es una fecha
 */
int esFecha(char cadena[] , int rango);
